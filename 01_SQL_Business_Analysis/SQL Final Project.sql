...
(2, 2, 'Fuller', 'Andrew', 'Vice President', 'Dr.', '1952-02-09', '1992-08-04', 10000.00, NULL),
(8, 2, 'Callahan', 'Laura', 'Sales Assistant', 'Miss', '1958-01-09', '1994-03-05', 2000.00, NULL),
(4, 2, 'Peacock', 'Margaret', 'Sales Representative', 'Mrs.', '1958-09-09', '1993-05-03', 2856.00, 250.00),
(3, 2, 'Leverling', 'Janet', 'Sales Representative', 'Miss', '1963-08-10', '1992-04-01', 3500.00, 1000.00),
(1, 2, 'Davolio', 'Nancy', 'Sales Representative', 'Miss', '1968-12-08', '1992-05-01', 3135.00, 1500.00),
(5, 2, 'Buchanan', 'Steven', 'Sales Manager', 'Mr.', '1955-03-04', '1993-10-07', 8000.00, NULL),
(9, 5, 'Dodsworth', 'Anne', 'Sales Representative', 'Miss', '1969-07-02', '1994-11-05', 2180.00, 0.00),
(6, 5, 'Suyama', 'Michael', 'Sales Representative', 'Mr.', '1963-07-02', '1993-10-07', 2534.00, 600.00),
(7, NULL, 'King', 'Robert', 'Sales Representative', 'Mr.', '1960-05-09', '1994-01-02', 2356.00, 800.00);
...
SET p.SUPPLIER_int = 1
WHERE UPPER(c.CATEGORY_NAME) = 'BOISSONS';
...
SELECT PRODUCT_REF, PRODUCT_NAME, 
SUPPLIER_int, UNITS_ON_ORDER, UNIT_PRICE
FROM products
WHERE 
Lower(QUANTITY LIKE '%bottles%')
AND (PRODUCT_NAME LIKE '__t%' OR PRODUCT_NAME LIKE '__T%')
AND SUPPLIER_int IN (1, 2, 3)
AND UNIT_PRICE BETWEEN 20 AND 200
AND UNITS_ON_ORDER IS NOT NULL;

# 3. Display customers who reside in the same region as supplier 1, meaning they share the same country, city, 
...
# discount (unit price * quantity) is between 0 and 2000, 5% if between 2001 and 10000, 
# 10% if between 10001 and 40000, 15% if between 40001 and 80000, and 20% otherwise.
# 5. -Display the message "apply old discount rate" if the order number is between 10000 and 10999, 
...
FROM
    order_details
WHERE
    ORDER_int BETWEEN 10998 AND 11003
GROUP BY ORDER_int;


# 6. Display suppliers of beverage products. The resulting table should display the 
...
JOIN CATEGORIES c 
    ON p.CATEGORY_CODE = c.CATEGORY_CODE
WHERE LOWER(c.CATEGORY_NAME) = 'beverages';

# 7. Display customers from Berlin who have ordered at most 1 (0 or 1) dessert product. 
...
SELECT 
    ...
    SUM(
        CASE 
            WHEN LOWER(cat.CATEGORY_NAME) = 'desserts' THEN 1
            ELSE 0
        END
    ) AS DESSERT_COUNT
FROM CUSTOMERS c
...
HAVING DESSERT_COUNT <= 1;

# 8. Display customers who reside in France and the total amount of orders they placed every Monday in April 1998 
# (considering customers who haven't placed any orders yet). The resulting table should display the 
...
# 9. Display customers who have ordered all products. The resulting table should display 
# the columns: customer code, company name, and telephone number.
...
GROUP BY 
    ...
    c.PHONE
HAVING 
    COUNT(DISTINCT od.PRODUCT_REF) = (
        SELECT COUNT(*) FROM PRODUCTS
    );

SELECT 
    CUSTOMER_CODE,
    COUNT(DISTINCT PRODUCT_REF) AS PRODUCTS_ORDERED
FROM ORDERS o
JOIN ORDER_DETAILS od 
    ON o.ORDER_int = od.ORDER_int
...
ORDER BY PRODUCTS_ORDERED DESC;
 ...
 # 10. Display for each customer from France the number of orders they have placed.
...
# 11. Display the number of orders placed in 1996, the number of orders placed in 1997, 
# and the difference between these two numbers. The resulting table should display 
# the columns: orders in 1996, orders in 1997, and Difference.
...
SELECT 
    ...
    COUNT(CASE WHEN YEAR(ORDER_DATE) = 1996 THEN 1 END) 
    AS DIFFERENCE
FROM ORDERS;
